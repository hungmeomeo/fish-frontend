    ...
    async function getProduct() {
      try {
        const response = await axios.get(
          "https://fish-staging.onrender.com/query/item/all"
        );
      ...
      {product.length > 0 ? (
        <Fragment>
          ...
          <div
            style={{
              backgroundImage:
                "url('https://drive.google.com/uc?id=17OI5Cy9suNiXAFrncruzZpwLIH35qVPz')",
              backgroundRepeat: "no-repeat ",
              backgroundSize: "100% 800px",
            }}
            className="w-full h-[800px] text-center text-white font-bold"
          >
            <h1 className="pt-10 text-[60px]">ANGLER VIETNAM</h1>
            <p>NHÃN HÀNG YÊU THÍCH CỦA BẠN ĐỀU CÓ Ở ĐÂY!!!</p>
          </div>
          ...
          <div
            style={{
              backgroundImage:
                "url('https://drive.google.com/uc?id=11e9Pxh79V5NCreBKl5Hol-2ofmsvJIyi')",
              backgroundRepeat: "no-repeat ",
              backgroundSize: "100% 800px",
            }}
            className=" w-full h-[800px] text-center text-white font-bold"
          >
            ...
            <h1 className="text-[60px]">BỘ SƯU TẬP CẦN CÂU ĐỘC NHẤT</h1>
          </div>
          <div className="pt-10 w-full h-[800px] text-center text-black">
            <h1 className="text-[30px] font-bold">NHÃN HÀNG TOP ĐẦU</h1>
            <hr className="w-48 h-1 mx-auto my-4 bg-black border-0 rounded md:my-10 dark:bg-gray-700"></hr>
            <Container>
              <Grid
                container
          ...
          <div
            style={{
              backgroundImage:
                "url('https://drive.google.com/uc?id=1B0iuSY2CNWCd9ReLF9DROEmLU78mGK1u')",
              backgroundRepeat: "no-repeat ",
              backgroundSize: "100% 800px",
            }}
            className="w-full h-[800px] text-center text-white font-bold"
